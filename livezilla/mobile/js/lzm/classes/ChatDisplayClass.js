                ...
                for(var i = 0;i<memberList.length;i++)
                {
                    ...
                    if(!isHidden && $.inArray(membId,addedMembers)===-1)
                    {
                        ...
                        if(operator != null)
                        {
                            ...
                            operatorsHTML += '<div '+nameWidth+' id="'+(chat.SystemId+'-'+i)+'" class="lzm-unselectable chat-member-div '+chat.SystemId+'">'+icon+lzm_commonTools.SubStr(operator.name,22,true) + sit + '</div>';
                        }
